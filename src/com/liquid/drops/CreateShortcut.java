...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.liquid.drops.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), LiquidSettingsActivity.class);
        shortcutIntent.setAction("com.liquid.drops.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("liquid_fragment_name", intentClass);
...
//		FIX ME
//        if (c.equals("Buttons"))
            return R.drawable.ic_liquid_main_settings_teal;
//        else
//            return R.mipmap.ic_liquid_main_settings_teal;
    }
