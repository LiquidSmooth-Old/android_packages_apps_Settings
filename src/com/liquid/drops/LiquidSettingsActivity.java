...
import com.android.settings.liquid.gestureanywhere.*;
import com.android.settings.slim.*;
import com.android.settings.slim.dslv.*;
import com.liquid.drops.fragments.*;

public class LiquidSettingsActivity extends PreferenceActivity implements ButtonBarHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!onIsHidingHeaders() && onIsMultiPane()) {
            ...
            setTitle(R.string.liquid_drops_title);
        }

        if ("com.liquid.drops.START_NEW_FRAGMENT".equals(getIntent().getAction())) {
            String className = getIntent().getStringExtra("liquid_fragment_name").toString();
            Class<?> cls = null;
            try {
    ...
    private static final String[] ENTRY_FRAGMENTS = {
        ...
        LiquidnotificationSettings.class.getName(),
    ...
    public void onBuildHeaders(List<Header> headers) {
        loadHeadersFromResource(R.xml.liquid_preference_headers, headers);
