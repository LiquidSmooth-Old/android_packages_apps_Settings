...
package com.liquid.drops.preference;
...
import com.liquid.drops.ButtonBarHandler;
import com.liquid.drops.DialogCreatable;
    ...
    public boolean startFragment(
        ...
        if (getActivity() instanceof PreferenceActivity) {
            ...
            preferenceActivity.startPreferencePanel(fragmentClass, extras,
                    R.string.liquid_drops_title, null, caller, requestCode);
            return true;
        } else {
