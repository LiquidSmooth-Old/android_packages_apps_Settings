...
public class Pie extends SettingsPreferenceFragment
    ...
    private static final String PA_PIE_MODE = "pie_mode";
    private static final String PA_PIE_SIZE = "pa_pie_size";
    private static final String PA_PIE_TRIGGER = "pie_trigger";
    private static final String PA_PIE_ANGLE = "pie_angle";
    private static final String PA_PIE_GAP = "pie_gap";
    private static final String PA_PIE_NOTIFICATIONS = "pie_notifications";
    private static final String PA_PIE_MENU = "pa_pie_menu";
    private static final String PA_PIE_SEARCH = "pie_search";
    private static final String PA_PIE_CENTER = "pie_center";
    private static final String PA_PIE_STICK = "pie_stick";
