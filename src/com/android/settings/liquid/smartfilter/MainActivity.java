...
public class MainActivity extends Activity implements OnSeekBarChangeListener {
    ...
    private void makeNotification(){
        ...
        nb.setSmallIcon(R.drawable.ic_liquid_screen_filter);
        nb.setContentTitle(getText(R.string.filter_notification_title));
        nb.setContentText(getText(R.string.filter_notification_message));
