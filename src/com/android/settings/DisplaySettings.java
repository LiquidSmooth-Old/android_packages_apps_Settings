...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static final String LIQUID_CATEGORY = "category_liquid_options";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isColorEnhancementSupported()) {
            liquidPrefs.removePreference(mColorEnhancement);
            mColorEnhancement = null;
        }

        if (!DisplayColor.isSupported()) {
            liquidPrefs.removePreference(findPreference(KEY_DISPLAY_COLOR));
        }
        if (!DisplayGamma.isSupported()) {
            liquidPrefs.removePreference(findPreference(KEY_DISPLAY_GAMMA));
        }
