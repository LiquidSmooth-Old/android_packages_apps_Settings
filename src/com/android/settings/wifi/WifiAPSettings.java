...
public class WifiAPSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        Thread scanThread = new Thread() {
            public void run() {
                while (mWifiManager.getWifiApState() == WifiManager.WIFI_AP_STATE_ENABLED) {
                    try {
                        Log.i(TAG, "Scan...");
                        scan();
                        Thread.sleep(500);
    ...
    class WifiApManager {
         ...
         * @return ArrayList of {@link WifiAPSettings.ClientScanResult}
         */
                        ...
                        if ((splitted != null) && (splitted.length >= 4)) {
                            ...
                            if (mac.matches("..:..:..:..:..:..")) {
                                ...
                                if (!onlyReachables || isReachable) {
                                    result.add(new WifiAPSettings.ClientScanResult(splitted[0], splitted[3], splitted[5], isReachable));
                                }
                            }
                        }
                    }
