...
public class WirelessSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNfcPollingMode.setValue((Settings.liquid.getInt(activity.getContentResolver(),
                Settings.liquid.NFC_POLLING_MODE, 3)) + "");
        updateNfcPolling();
    ...
    private void updateNfcPolling() {
        int resId;
        String value = Settings.liquid.getString(getContentResolver(),
                Settings.liquid.NFC_POLLING_MODE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mSmsApplicationPreference && newValue != null) {
            ...
            Settings.liquid.putInt(getActivity().getContentResolver(),
                    Settings.liquid.NFC_POLLING_MODE, newVal);
            updateNfcPolling();
            return true;
        }
        return false;
